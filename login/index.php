    ...
    <div class="login-box">
      <div class="card card-outline card-primary">
        <div class="card-header text-center">
          <img src="<?php echo $base_url; ?>/dist/img/<?php echo $logo; ?>" alt="Logo" class="img-fluid" style="max-height: 100px; margin-bottom: 1rem;">
          <h1 class="mb-0"><b><?php echo $app_name; ?></b></h1>
        </div>
          ...
          <form id="loginForm">
            ...
            <div class="input-group mb-1">
              <div class="form-floating">
                <input id="loginUsername" name="username" type="text" class="form-control" value="" placeholder="Username" />
